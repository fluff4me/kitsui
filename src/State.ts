...
type SupplierOr<T, A extends any[] = []> = T | ((...args: A) => T)
const NO_OP = () => { }
const resolve = <T, A extends any[]> (value: SupplierOr<T, A>, ...args: A): T => (
	typeof value !== 'function' ? value : (value as (...args: A) => T)(...args)
)
